...
SECRET_KEY = 'django-insecure-g33-9j5dce4v+p!vl(v7dht)fmms@6-8_@%jred#h&&-#r*k(*'
...
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': 'djeiyqkkg',
    'API_KEY': '568212298632687',
    'API_SECRET': 't_ZS9b7LIStrXnc2jcqAE4k35eI'
}
